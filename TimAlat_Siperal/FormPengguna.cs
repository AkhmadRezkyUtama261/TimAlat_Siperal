...
private void btnUbah_Click(object sender, EventArgs e)
{
    if (idPeminjam == 0) { MessageBox.Show("Pilih data yang mau diubah dulu dari tabel!"); return; }
...
private void btnHapus_Click(object sender, EventArgs e)
{
    if (idPeminjam == 0) { MessageBox.Show("Pilih dulu data yang mau dihapus dari tabel!"); return; }
